...
impl Runtime {
    pub fn instantiate(wasm: impl AsRef<[u8]>) -> Result<Self, anyhow::Error> {
    ...
    pub fn call(&mut self, idx: usize, args: Vec<Value>) -> Result<Option<Value>, anyhow::Error> {
    ...
    fn invoke_internal(&mut self, func: InternalFuncInst) -> Result<Option<Value>, anyhow::Error> {
...
pub fn stack_unwind(stack: &mut Vec<Value>, sp: usize, arity: usize) -> Result<(), anyhow::Error> {
    if arity > 0 {
